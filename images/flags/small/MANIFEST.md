# Small Flag Images (24x18)

This directory should contain flag images for all countries used in the F1 Dashboard.
...
for code in gb us de fr it es au jp cn br mx ca nl mc ch ae sa qa bh th tw ru fi ar nz za dk xx; do
  curl -o "${code}.png" "https://flagcdn.com/24x18/${code}.png"
done
```
